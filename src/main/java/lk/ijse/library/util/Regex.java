...
public class Regex {
    ...
    private static final Pattern userName = Pattern.compile("[a-zA-Z]@!#$/{4,}$");
    private static final Pattern passwordPattern = Pattern.compile("[a-zA-Z]@!#$/{4,}$");
    ...
    public static Pattern getRegistrationIdPattern() {
    ...
    public static Pattern getPostalCodePattern() {
